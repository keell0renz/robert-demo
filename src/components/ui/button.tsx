...
import type { PolymorphicComponentProps } from "@/components/ui/utils/polymorphic";
import { recursiveCloneChildren } from "@/components/ui/utils/recursive-clone-children";
...
export const buttonVariants = tv({
  slots: {
    root: [
      ...
      "focus:outline-none",
      // disabled
      "cursor-pointer disabled:cursor-not-allowed disabled:bg-muted disabled:text-foreground-disabled disabled:ring-transparent",
    ],
    icon: [
      // base
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-card text-primary-base ring-primary-base",
          // hover
    ...
    },
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-card hover:ring-primary-base",
          // focus
          "focus-visible:bg-card focus-visible:shadow-button-primary-focus focus-visible:ring-primary-base",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-card text-muted-foreground shadow-regular-xs ring-border",
          // hover
    ...
    },
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-card hover:text-foreground hover:shadow-regular-xs hover:ring-border",
          // focus
          "focus-visible:bg-card focus-visible:text-foreground focus-visible:shadow-button-important-focus focus-visible:ring-ring",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-card text-error-base ring-error-base",
          // hover
    ...
    },
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-card hover:ring-error-base",
          // focus
          "focus-visible:bg-card focus-visible:shadow-button-error-focus focus-visible:ring-error-base",
        ],
      },
    },
    {
...
const ButtonRoot = React.forwardRef<HTMLButtonElement, ButtonRootProps>(({ children, variant, mode, size, asChild, className, ...rest }, forwardedRef) => {
